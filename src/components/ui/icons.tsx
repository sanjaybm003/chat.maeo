...
export const IconSpark = (p: IconProps) => (
  <Svg {...p}>
    <path d="M9 3.5c.55 3.35 2.3 5.1 5.75 5.75C11.3 9.9 9.55 11.65 9 15c-.55-3.35-2.3-5.1-5.75-5.75C6.7 8.6 8.45 6.85 9 3.5Z" />
    <path d="M15.25 12.75v3.5M13.5 14.5H17" />
  </Svg>
);

export const IconStop = (p: IconProps) => (
  <Svg {...p}>
    <rect x="5.5" y="5.5" width="9" height="9" rx="2" fill="currentColor" stroke="none" />
  </Svg>
);
...
export const IconCalendar = (p: IconProps) => (
  <Svg {...p}>
    <rect x="3.25" y="4.5" width="13.5" height="12.25" rx="3" />
    <path d="M3.25 8.5h13.5M7 3v3M13 3v3" />
  </Svg>
);
...
export const IconGlobe = (p: IconProps) => (
  <Svg {...p}>
    <circle cx="10" cy="10" r="6.75" />
    <path d="M3.25 10h13.5M10 3.25c1.9 2 2.75 4.25 2.75 6.75S11.9 14.75 10 16.75C8.1 14.75 7.25 12.5 7.25 10S8.1 5.25 10 3.25Z" />
  </Svg>
);

export const IconChat = (p: IconProps) => (
  <Svg {...p}>
    <path d="M4 5.75A2.75 2.75 0 0 1 6.75 3h6.5A2.75 2.75 0 0 1 16 5.75v5.5A2.75 2.75 0 0 1 13.25 14H9l-3.5 3v-3h-.25A1.25 1.25 0 0 1 4 12.75v-7Z" />
  </Svg>
);

/** GitHub's mark, for the GitHub connection only. */
export const IconGithub = ({ size = 18, ...props }: IconProps) => (
  <svg viewBox="0 0 16 16" width={size} height={size} fill="currentColor" aria-hidden="true" focusable="false" {...props}>
